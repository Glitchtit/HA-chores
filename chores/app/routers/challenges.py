...
def get_active_challenge():
    """Return this week's challenge (active or just-completed), with progress, or null.

    A completed challenge stays visible until its period ends so the household can
    see the win and the coins it earned.
    """
    conn = get_connection()
