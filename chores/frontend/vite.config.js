...
/** Parse `## X.Y.Z` headers out of CHANGELOG.md at build time so the frontend
 * can ship a "what's new" popup without a runtime fetch. */
...
export default defineConfig({
  ...
  define: {
    ...
    __APP_ID__: JSON.stringify('chores'),
  },
  build: {
    outDir: 'dist',
    sourcemap: false,
